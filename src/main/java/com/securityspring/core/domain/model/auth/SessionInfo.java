...
/**
 * Representa uma sessão ativa do usuário (refresh token não expirado e não revogado).
 *
 ...
 * @param ipAddress IP do cliente no momento do login (pode ser null para sessões antigas)
 * @param userAgent User-Agent do cliente no momento do login (pode ser null para sessões antigas)
 */
