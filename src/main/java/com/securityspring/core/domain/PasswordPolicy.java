 ...
 *
 * <p>Tanto a validação no service quanto as anotações de Bean Validation nos DTOs devem
 * referenciar as constantes desta classe, garantindo que uma mudança de política
 * (ex: exigir 12 chars ou proibir sequências) seja feita em um único lugar.</p>
 *
 * <p>Regras atuais:
 * <ul>
...
public final class PasswordPolicy {
     ...
     * Exige ao menos: uma maiúscula, uma minúscula, um dígito e um caractere especial.
     * Usada em {@code @Pattern} nos DTOs e em {@link #isValid(String)} no service.
     */
    public static final String COMPLEXITY_REGEXP =
            "^(?=.*[A-Z])(?=.*[a-z])(?=.*\\d)(?=.*[^A-Za-z\\d]).+$";
