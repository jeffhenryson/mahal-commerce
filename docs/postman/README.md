...
| Vendas Balcão (PDV) | [`dominios/vendas-balcao/vendas-balcao.postman_collection.json`](../dominios/vendas-balcao/vendas-balcao.postman_collection.json) | Sessões de caixa e venda com baixa automática de estoque, incluindo o rollback por saldo insuficiente | Uma sessão de caixa `OPEN` (SQL abaixo) |
